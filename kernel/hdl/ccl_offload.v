...
(
  ...
  output [31:0]s_axis_hls_control_tdata,
  output [3:0]s_axis_hls_control_tkeep,
  output [0:0]s_axis_hls_control_tlast,
  input s_axis_hls_control_tready,
  output [3:0]s_axis_hls_control_tstrb,
  output s_axis_hls_control_tvalid,
  output [31:0]m_axis_hls_control_result_tdata,
  output [3:0]m_axis_hls_control_result_tkeep,
  output [0:0]m_axis_hls_control_result_tlast,
  input m_axis_hls_control_result_tready,
  output [3:0]m_axis_hls_control_result_tstrb,
  output m_axis_hls_control_result_tvalid,
  ...
  ccl_offload_bd ccl_offload_bd_i
       (.ap_clk(ap_clk),
        ...
        .s_axis_hls_control_tdata(s_axis_hls_control_tdata),
        .s_axis_hls_control_tkeep(s_axis_hls_control_tkeep),
        .s_axis_hls_control_tlast(s_axis_hls_control_tlast),
        .s_axis_hls_control_tready(s_axis_hls_control_tready),
        .s_axis_hls_control_tstrb(s_axis_hls_control_tstrb),
        .s_axis_hls_control_tvalid(s_axis_hls_control_tvalid),
        .m_axis_hls_control_result_tdata(m_axis_hls_control_result_tdata),
        .m_axis_hls_control_result_tkeep(m_axis_hls_control_result_tkeep),
        .m_axis_hls_control_result_tlast(m_axis_hls_control_result_tlast),
        .m_axis_hls_control_result_tready(m_axis_hls_control_result_tready),
        .m_axis_hls_control_result_tstrb(m_axis_hls_control_result_tstrb),
        .m_axis_hls_control_result_tvalid(m_axis_hls_control_result_tvalid),
