...
(
  ...
  input [31:0]hls_control_tdata,
  output hls_control_tready,
  input hls_control_tvalid,
  input hls_control_tlast,
  output [31:0]hls_control_result_tdata,
  input hls_control_result_tready,
  output hls_control_result_tvalid,
  output hls_control_result_tlast,
  ...
  ccl_offload_bd ccl_offload_bd_i
       (.ap_clk(ap_clk),
        ...
        .hls_control_tdata(hls_control_tdata),
        .hls_control_tready(hls_control_tready),
        .hls_control_tvalid(hls_control_tvalid),
        .hls_control_tlast(hls_control_tlast),
        .hls_control_result_tdata(hls_control_result_tdata),
        .hls_control_result_tready(hls_control_result_tready),
        .hls_control_result_tvalid(hls_control_result_tvalid),
        .hls_control_result_tlast(hls_control_result_tlast),
