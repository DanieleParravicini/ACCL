...
set s_axis_tcp_notification [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_tcp_notification ]
  ...
  #dma_enqueue
   ...
   assign_bd_address -offset 0x00001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces control/dma_enqueue_0/Data_m_axi_mem] [get_bd_addr_segs control/microblaze_0_exchange_memory/axi_bram_ctrl_bypass/S_AXI/Mem0] -force
  ...
  #dma_dequeue
   ...
   #2. mcu access to ctrl via axilite
   assign_bd_address -offset 0x44D00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces control/microblaze_0/Data] [get_bd_addr_segs control/dma_enqueue_0/s_axi_control/Reg] -force
  # DMA ddr
