...
proc create_hier_cell_dma { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_datamover_M_AXI          [get_bd_intf_pins dma_aximm] [get_bd_intf_pins axi_datamover_0/M_AXI]
  connect_bd_intf_net -intf_net axi_datamover_AXIS_MM2S      [get_bd_intf_pins dma_mm2s ] [get_bd_intf_pins axi_datamover_0/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_datamover_AXIS_S2MM      [get_bd_intf_pins dma_s2mm ] [get_bd_intf_pins axi_datamover_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_datamover_AXIS_MM2S_STS  [get_bd_intf_pins axi_datamover_0/M_AXIS_MM2S_STS] [get_bd_intf_pins axis_subset_cnv_sts_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_datamover_AXIS_S2MM_STS  [get_bd_intf_pins axi_datamover_0/M_AXIS_S2MM_STS] [get_bd_intf_pins axis_subset_cnv_sts_1/S_AXIS]
  connect_bd_intf_net -intf_net axi_datamover_mm2s_cmd       [get_bd_intf_pins dma_mm2s_cmd] [get_bd_intf_pins axi_datamover_0/S_AXIS_MM2S_CMD]
  connect_bd_intf_net -intf_net axi_datamover_s2mm_cmd       [get_bd_intf_pins dma_s2mm_cmd] [get_bd_intf_pins axi_datamover_0/S_AXIS_S2MM_CMD]
  connect_bd_intf_net -intf_net axis_subset_cnv_sts_0_M_AXIS [get_bd_intf_pins dma_mm2s_sts] [get_bd_intf_pins axis_subset_cnv_sts_0/M_AXIS]
  ...
  connect_bd_net -net ap_clk   [get_bd_pins ap_clk  ] \
                               ...
                               [get_bd_pins axis_subset_cnv_sts_1/aclk] 
  ...
  connect_bd_net -net ap_rst_n [get_bd_pins ap_rst_n] \
                               ...
                               [get_bd_pins axis_subset_cnv_sts_1/aresetn] 
